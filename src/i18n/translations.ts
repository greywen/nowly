...
export const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'workbench.empty': 'dev-modules 目录下没有草稿。把 .js 文件写到下面这个目录即可预览：',
  ...
  en: {
    ...
    'workbench.empty': 'No drafts under dev-modules. Write a .js file to the directory below to preview it:',
